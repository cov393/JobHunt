...
export default {
  ...
  //       categoriesSet.add(this.job.category);
  //     }
  ...
  computed: {
    ...
    filteredJobs() {
      ...
      if (this.sortOption === "latest-date") {
        jobs.sort((a,b) => new Date(b.posted_date).toLocaleDateString("en-US") - new Date(a.posted_date).toLocaleDateString("en-US"));
